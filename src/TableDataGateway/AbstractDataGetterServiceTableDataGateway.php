 ...
 * @template TOrder
 * @extends  AbstractDataGetterTableDataGateway<TItem, TExpression, TParameters, TOrder>
 */
abstract class AbstractDataGetterServiceTableDataGateway extends AbstractDataGetterTableDataGateway
{
